...
//
//  Otherwise, if it is positive, calculate the value of miles per hour, round it and return it. For
//  conversion and rounding, check the notes in the text below.
//
...
//  and typecasting the result to type long. The method returns the value of the argument rounded to the
//  nearest int value.
//
